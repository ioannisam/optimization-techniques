...
figure;
sgtitle('Dichotomous (with derivative): Function evaluations vs l', 'FontWeight','bold');
for i = 1:3
...
figure;
sgtitle('Dichotomous (with derivative): Interval endpoints a_k, b_k vs iteration k for different l', 'FontWeight','bold');
for i = 1:3
    for j = 1:length(l_values)
        l = l_values(j);
